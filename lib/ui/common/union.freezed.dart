...
abstract class $UnionCopyWith<T, $Res> {
  factory $UnionCopyWith(Union<T> value, $Res Function(Union<T>) then) =
      _$UnionCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$UnionCopyWithImpl<T, $Res> implements $UnionCopyWith<T, $Res> {
  _$UnionCopyWithImpl(this._value, this._then);

  final Union<T> _value;
  // ignore: unused_field
  final $Res Function(Union<T>) _then;
}
...
/// @nodoc
class _$DataCopyWithImpl<T, $Res> extends _$UnionCopyWithImpl<T, $Res>
...
/// @nodoc
class _$LoadingCopyWithImpl<T, $Res> extends _$UnionCopyWithImpl<T, $Res>
...
/// @nodoc
class _$ErrorDetailsCopyWithImpl<T, $Res> extends _$UnionCopyWithImpl<T, $Res>
